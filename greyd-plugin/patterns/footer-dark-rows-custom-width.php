<?php
/**
 * Title: Dark footer built with rows and custom width control
 * Slug: greyd-plugin/footer-dark-rows-custom-width
...
<div class="wp-block-group has-background-color has-foreground-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large)">
	...
	<div class="wp-block-group alignwide">
		...
		<!-- wp:group {"className":"","style":{"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"space-between","verticalAlignment":"top"},"greydStyles":{"width":null,"maxWidth":"60%","responsive":{"md":{"maxWidth":"100%"}}}} -->
		<div class="wp-block-group">
			<!-- wp:group {"className":"","style":{"spacing":{"blockGap":"var:preset|spacing|tiny"}},"layout":{"type":"flex","orientation":"vertical"},"greydStyles":{"responsive":{"md":{"width":""},"sm":{"width":"100%"}}}} -->
			<div class="wp-block-group">
			...
			<div class="wp-block-group">
				<!-- wp:group {"className":"","style":{"spacing":{"blockGap":"var:preset|spacing|tiny"},"layout":{"selfStretch":"fill","flexSize":null}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
				<div class="wp-block-group">
					<!-- wp:paragraph {"className":""} -->
					<p><strong><?php esc_html_e( 'Contact Form', 'greyd_hub' ); ?></strong></p>
					<!-- /wp:paragraph -->

					<!-- wp:paragraph {"className":"","fontSize":"tiny"} -->
					<p class="has-tiny-font-size"><?php esc_html_e( 'Please insert your contact form here', 'greyd_hub' ); ?></p>
					<!-- /wp:paragraph -->
