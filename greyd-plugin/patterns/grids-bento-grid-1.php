...
/**
 * Title: Bento Grid 1
 * Slug: greyd-plugin/grids-bento-grid-1
 * Description: 
 ...
 */
?>
<!-- wp:group {"align":"wide","className":"grid-max-3","style":{"dimensions":{"minHeight":"70vh"}},"layout":{"type":"grid","minimumColumnWidth":"18rem"}} -->
<div class="wp-block-group alignwide grid-max-3" style="min-height:70vh">
	...
	<div class="wp-block-group has-base-background-color has-background" style="min-height:240px">
		...
		<h2 class="wp-block-heading"><?php esc_html_e( 'Block-based &amp; accessible', 'greyd_hub' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group has-base-background-color has-background" style="min-height:240px">
		...
		<div class="wp-block-group">
			<!-- wp:heading {"className":""} -->
			<h2 class="wp-block-heading"><?php esc_html_e( 'Any layout is possible.', 'greyd_hub' ); ?></h2>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":""} -->
			<p><?php esc_html_e( 'Bento / Masonry Grid 01', 'greyd_hub' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-greyd-buttons">
			<!-- wp:greyd/button {"content":"<?php esc_html_e( 'Button', 'greyd_hub' ); ?>","className":""} -->
			<a role="trigger" class="button"><?php esc_html_e( 'Button', 'greyd_hub' ); ?></a>
			<!-- /wp:greyd/button -->
		</div>
		<!-- /wp:greyd/buttons -->
	</div>
	...
	<!-- wp:group {"className":"","style":{"layout":{"rowSpan":2},"dimensions":{"minHeight":"240px"},"background":{"backgroundImage":{"url":"<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'assets/img/dark-transparent-background-pattern.webp' ); ?>","source":"file","title":""},"backgroundSize":"cover"}},"backgroundColor":"base","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
