<?php
/**
 * Title: Animated price card with link, medium dark
 * Slug: greyd-plugin/dt-cards-animated-price-card-link-medium-dark
 * Description: 
...
<!-- wp:group {"metadata":{"name":"<?php esc_html_e( 'Animated price card with link, medium dark', 'greyd_hub' ); ?>"},"className":"hover","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"blockGap":"var:preset|spacing|x-large"},"border":{"radius":"16px"}},"backgroundColor":"dark","textColor":"background","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","verticalAlignment":"space-between"}} -->
<div class="wp-block-group hover has-background-color has-dark-background-color has-text-color has-background has-link-color" style="border-radius:16px">
	...
	<div class="wp-block-group">
		...
		<!-- wp:greyd/buttons {"className":"","greydAnim":{"action":"show","preset":"fadeInDown","from":"","to":"","origin":"center center","event":"parentHover","parent":".hover","start":"50%","end":"50%","reverse":false,"duration":200,"delay":0,"timing":"ease"}} -->
