...
/**
 * Title: Bento Grid 2
 * Slug: greyd-plugin/grids-bento-grid-2
 * Description: 
 ...
 */
?>
<!-- wp:group {"align":"wide","className":"grid-max-2","style":{"dimensions":{"minHeight":"70vh"},"spacing":{"blockGap":"0"}},"layout":{"type":"grid","minimumColumnWidth":"26rem"}} -->
<div class="wp-block-group alignwide grid-max-2" style="min-height:70vh">
	...
	<div class="wp-block-group has-base-background-color has-background" style="min-height:240px">
		...
		<h2 class="wp-block-heading"><?php esc_html_e( 'Streamlined page building', 'greyd_hub' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group has-base-background-color has-background" style="min-height:240px">
		...
		<div class="wp-block-group">
			...
			<p><?php esc_html_e( 'Bento / Masonry Grid 02', 'greyd_hub' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	...
	<!-- wp:group {"className":"","style":{"layout":{"rowSpan":2},"dimensions":{"minHeight":"240px"},"background":{"backgroundImage":{"url":"<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'assets/img/dark-transparent-background-pattern.webp' ); ?>","source":"file","title":"dark-transparent-background-pattern"},"backgroundSize":"cover"}},"backgroundColor":"base","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
