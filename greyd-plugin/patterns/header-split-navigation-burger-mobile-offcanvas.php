<?php
/**
 * Title: Header with split navigation and burger with mobile off-canvas
 * Slug: greyd-plugin/header-split-navigation-burger-mobile-offcanvas
 * Description: 
 ...
 */
?>
<!-- wp:group {"metadata":{"name":"<?php esc_html_e( 'Header with split navigation and burger with mobile off-canvas', 'greyd_hub' ); ?>"},"className":"","layout":{"type":"constrained"}} -->
		...
		<div class="wp-block-group">
			...
			<!-- wp:greyd/popover {"hidden":{"xs":false,"sm":false,"md":true,"lg":true},"className":""} -->
				...
				<!-- wp:greyd/popover-popup {"variation":"offcanvas","greydStyles":{"--dialog-margin":"0px 0 0px 0","--dialog-background":"var(--wp--preset--color--primary)","--dialog-color":"var(--wp--preset--color--background)","--dialog-width":"480px","responsive":{"sm":{"--dialog-width":"100%"}}},"className":""} -->
					<!-- wp:group {"className":"","style":{"spacing":{"padding":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium"},"blockGap":"var:preset|spacing|small"}},"layout":{"type":"constrained"}} -->
