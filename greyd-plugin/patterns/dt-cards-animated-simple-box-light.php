<?php
/**
 * Title: Animated simple box, light
 * Slug: greyd-plugin/dt-cards-animated-simple-box-light
 * Description: 
 ...
 */
?>
<!-- wp:group {"metadata":{"categories":["greyd-content"],"patternName":"greyd-theme/content-simple-box-light","name":"<?php esc_html_e( 'Animated simple box, light', 'greyd_hub' ); ?>"},"className":"","style":{"border":{"radius":"8px"},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"backgroundColor":"base","layout":{"type":"default"}} -->
<div class="wp-block-group has-base-background-color has-background" style="border-radius:8px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
	<!-- wp:cover {"url":"<?php echo esc_url( plugin_dir_url( __DIR__ ) . 'assets/img/greyd-placeholder-image-white-300x300.svg' ); ?>","dimRatio":0,"minHeight":240,"minHeightUnit":"px","contentPosition":"top right","isDark":false,"className":"","style":{"color":{"duotone":"var:preset|duotone|foreground-background"},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|medium","bottom":"var:preset|spacing|medium","left":"var:preset|spacing|medium","right":"var:preset|spacing|medium"}},"border":{"radius":{"topLeft":"8px","topRight":"8px"}}}} -->
	<div class="wp-block-cover is-light has-custom-content-position is-position-top-right" style="border-top-left-radius:8px;border-top-right-radius:8px;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium);min-height:240px">
		...
		<div class="wp-block-cover__inner-container">
			<!-- wp:group {"className":"","style":{"elements":{"link":{"color":{"text":"var:preset|color|lightest"}}},"spacing":{"padding":{"top":"4px","bottom":"4px","left":"8px","right":"8px"}},"border":{"radius":"4px"}},"backgroundColor":"darkest","textColor":"lightest","layout":{"type":"constrained"},"greydAnim":{"action":"show","preset":"fadeInUp","from":"","to":"","origin":"center center","event":"onScroll","parent":"","start":"70%","end":"50%","reverse":true,"duration":200,"delay":0,"timing":"ease"}} -->
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
		...
		<div class="wp-block-buttons">
			...
			<div class="wp-block-button is-style-outline">
				<a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Learn more about Greyd', 'greyd_hub' ); ?></a>
			</div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
